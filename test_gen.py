...
class TestGen:
    ...
    def rand_test_bump(self):
        return f'BumpGradeToEmployees  {str(random.randint(-1, 1100000000))} {str(random.randint(1000000000, 2100000000))} {str(random.randint(-1, 2100000000))}'

    def rand_test_add(self):
        self.total_emp += 1
        return f'AddEmployee {str(random.randint(-1, 10000))} {str(random.randint(-1, self.companies + 1))}  {str(random.randint(-1, 2100000000))}'

    def rand_test_sal_increase(self):
        return f'EmployeeSalaryIncrease {str(random.randint(-1, 10000))} {str(random.randint(-1, 2100000000))}'

    def rand_test_promote(self):
        return f'PromoteEmployee {str(random.randint(-1, 10000))} {str(random.randint(-1, 2100000000))}'

    def rand_test_avg(self):
        return f'AverageBumpGradeBetweenSalaryByGroup  {str(random.randint(-1, self.companies + 1))} {str(random.randint(-1, 1100000000))} {str(random.randint(1000000000, 2100000000))}'
